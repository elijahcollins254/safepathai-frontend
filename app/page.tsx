...
function ResidentExperience({ apiBaseUrl, onOpenAdmin }: { apiBaseUrl: string; onOpenAdmin: () => void }) {
...
export default function Home() {
  const [viewMode, setViewMode] = useState<"resident" | "operator">("resident");
  ...
  if (viewMode === "resident") {
    return <ResidentExperience apiBaseUrl={apiBaseUrl} onOpenAdmin={() => setViewMode("operator")} />;
  }
  ...
  return (
    <main className="command-shell">
      ...
      <header className="topbar">
        ...
        <div className="top-actions"><button className="view-switch" onClick={() => setViewMode("resident")}>Resident view</button><span className="demo-pill"><i /> DEMO MODE</span><span className="sync"><i /> SYSTEMS ONLINE</span><button className="icon-button" aria-label="Settings">⚙</button><div className="operator">OP <span>AO</span></div></div>
      </header>
